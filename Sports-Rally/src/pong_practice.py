...
def main():
    ...
    def draw_objects():
        ...
        pygame.draw.line(screen, WHITE, (exit_button.left + 10, exit_button.top + 10),
                         (exit_button.right - 10, exit_button.bottom - 10), 3)
        pygame.draw.line(screen, WHITE, (exit_button.left + 10, exit_button.bottom - 10),
                         (exit_button.right - 10, exit_button.top + 10), 3)
