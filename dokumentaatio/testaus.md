...
- **HUOM!!** Jos käyttämänne näppäimistö ei ole NKRO(N-Key RollOver), voi olla, että pong toimii siinä tapauksessa todella hassusti.
...
- Jotkut rivit voi olla sellaisia, että ne toimiivat kyllä, mutta ne eivät pylintin silmissä ole siistejä, esim:
```
